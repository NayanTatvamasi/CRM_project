                                        ...
                                        <div class="col-xl-12 col-xxl-7">
                                            ...
                                            <form class="form" id="kt_form">
                                                ...
                                                <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                                    ...
                                                    <h4 class="mb-10 font-weight-bold text-dark">Vendor Information</h4>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="weight" placeholder="Enter your Organization Name" name="organization_name" id="organization_name" />
                                                    </div>
                                                    <!--end::Input-->
                                                ...
                                                <div class="pb-5" data-wizard-type="step-content">
                                                    <h4 class="mb-10 font-weight-bold text-dark">Setup Your Current
                                                        Location</h4>
                                                    <!--begin::Input-->
                                                    <div class="form-group">
                                                ...
                                                <!--begin: Wizard Step 3-->
                                                <div class="pb-5" data-wizard-type="step-content">
                                                    <h4 class="mb-10 font-weight-bold text-dark">Select your
                                                        Services</h4>
                                                    <!--begin::Select-->
                                                    <div class="form-group">
                                                ...
                                                <!--begin: Wizard Step 4-->
                                                <div class="pb-5" data-wizard-type="step-content">
                                                    <h4 class="mb-10 font-weight-bold text-dark">Setup Your Delivery
                                                        Location</h4>
                                                    <div class="my-5">
                                                        <!--begin::Input-->
                                                        <div class="form-group">
                                                ...
                                                <div class="pb-5" data-wizard-type="step-content">
                                                    ...
                                                    <div class="text-dark-50 line-height-lg">
                                                        <div>Package: Complete Workstation (Monitor, Computer,
                                                            Keyboard & Mouse)</div>
                                                        <div>Weight: 25kg</div>
